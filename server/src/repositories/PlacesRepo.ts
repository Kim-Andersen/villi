...
import { Place, PlaceCreation, PlaceId, PlaceUpdate, PlaceUpdateResult } from '../shared/types';
import { LatLng } from '../shared/types/LatLng';

export interface IPlacesRepo {
  searchNearby(location: LatLng, radius: number): Promise<Place[]>;
  /**
   * Find places.
   */
...
export default class PlacesRepo implements IPlacesRepo {
  ...
  public async searchNearby(location: LatLng, radius: number): Promise<Place[]> {
